    ...
    @auth
        <section class="seccion-perfil-usuario">
            <div class="perfil-usuario-header">
                <div class="perfil-usuario-portada">
                    ...
                    <button type="button" class="boton-portada">
                        <input type="file" name="imagen_fondo" id="imagen_fondo" placeholder="Cambiar fondo">
                    </button>
                </div>
            </div>
            <div class="perfil-usuario-body">
                ...
                <form id="form" action="{{ route('perfil.crear') }}" method="post">
                @csrf        
                    <input type="text" name="biografia" id="biografia" style="width: 100%; padding: 5px 5px" placeholder="Cuentanos tu vida :D">
                    </div>
                        <div class="perfil-usuario-footer">
                            <ul class="lista-datos">
                                <li><i class="icono fas fa-map-signs"></i><p><input type="text" name="direccioN" id="direccioN" style="width: 50%; padding: 5px 5px" placeholder="Dirección:"></p></li>
                                <li><i class="icono fas fa-phone-alt"></i><p><input type="text" name="telefono" id="telefono" style="width: 50%; padding: 5px 5px" placeholder="Teléfono:"></p></li>
                            </ul>
                            <ul class="lista-datos">
                                <li><i class="icono fas fa-map-marker-alt"></i><p><input type="text" name="interesadoen" id="interesadoen" style="width: 80%; padding: 5px 5px" placeholder="Interesado en:"></p></li>
                                <li><i class="icono fas fa-calendar-alt"></i><p><input type="text" name="fecha_nacimiento" id="fecha_nacimiento" style="width: 80%; padding: 5px 5px" placeholder="Fecha de nacimiento"></p></li>
