        ...
        @csrf
            <div class="perfil-usuario-header">
                <div class="perfil-usuario-portada">
                    ...
                    <button type="button" class="boton-portada">
                        <i class="far fa-image"><input type="file" name="imagen_fondo" id="imagen_fondo"></i> Cambiar fondo
                    </button>
                </div>
            </div>
            <div class="perfil-usuario-body">
                <div class="perfil-usuario-bio">
                    ...
                    <p class="texto"><input  type="text" name="biografia" id="biografia" style="width: 100%; padding: 5px 5px; margin-left: 58px" placeholder="Cuentanos tu vida :D">
                    </p>
                </div>
                <div class="perfil-usuario-footer">
                    <ul class="lista-datos">
                        <li><i class="icono fas fa-map-signs"></i><input type="text" name="direccioN" id="direccioN" style="width: 100%; padding: 5px 5px" placeholder="Dirección:"></li>
                        <li><i class="icono fas fa-phone-alt"></i><input type="text" name="telefono" id="telefono" style="width: 100%; padding: 5px 5px" placeholder="Teléfono:"></li>
                    </ul>
                    <ul class="lista-datos">
