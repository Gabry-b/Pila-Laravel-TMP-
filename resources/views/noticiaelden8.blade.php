    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">Así es Elden Ring en primera persona para realidad virtual gracias a un mod</h1></br>
                <p class="text-muted">Un mod convierte Elden Ring en un juego de VR en primera persona. El autor ha mostrado un pequeño clip de su creación, que actualmente está en desarrollo.</p></br>
                <img src="noticias/elden/n8.jpg" class="w-50" alt="">
                </br>
            </div>
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Nadie puede dudar que Elden Ring se ha convertido en todo un fenómeno; de lo contrario, no se habrían dado situaciones como el nacimiento de la leyenda 'Let me solo her' o que hasta el Betis lo use para promocionarse, y no existirían proyectos como el que pretende convertir el juego en un demake jugable para Game Boy.</div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  La comunidad no para de crear contenido inspirado en el último juego de FromSoftware, incluyendo mods que lo convierten en una coqueta miniatura o, como el caso que nos ocupa, una herramienta para jugarlo en primera persona en realidad virtual.</div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  El modder Luke Ross, especializado en adaptar juegos al formato VR, ha lanzado un nuevo vídeo en el que desvela que está trabajando en llevar Elden Ring a la realidad virtual. En lugar de mantener la tercera persona original, como en el resto de sus creaciones, el autor ha alterado la cámara para conseguir una impresionante perspectiva en primera persona que le da al universo del juego un toque más espectacular todavía. De momento sólo ha mostrado la parte inicial, antes de llegar al Necrolimbo, pero ya con eso nos vale para imaginar el resto del juego. Podéis verlo a continuación:
                </p>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  <video class="col-12" controls>
                    <source  type="video/mp4" src="noticias/videos/What is this sorcery.mp4">
                  </video>
                </p>
        </section>
    </article>
