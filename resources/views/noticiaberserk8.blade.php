    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">¿Por qué el manga Berserk no ha sido adaptado (de buena manera) al anime?</h1></br>
                <p class="text-muted">La obra maestra de Kentaro Miura ha tenido varias adaptaciones a las pantallas, pero ninguna de ellas a la altura del manga.</p></br>
                <img src="noticias/berserk/n8.jpg" class="w-50" alt="">
                </br>
            </div>
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  La primera fue en 1997 animada por Oriental Light and Magic. Abarca toda la edad dorada con excepcion de algunas escenas de la infancia de Guts, la persecucion del clan vakiraka y la batalla de los caballeros del perro negro. 
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  La segunda fue una trilogia de peliculas animadas por Studio 4°C que abarcan menos contenido que la serie del 97. Estas llegaron a Netflix, donde cautivaron a un montón de personas (yo entre ellas) para indagar y conocer más sobre la obra maestra de Kentaro.
                  Las 2 ultimas (2016–2017) fueron "animadas" por GEMBA, pero mejor no hablemos de esta.
                </div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  Todo esto se ha debido a una serie de catastróficas desdichas referentes a los estudios de animación, licencias y el mismo destino del manga, pues al estar inconcluso y ser tan subjetivamente lineal, era complicado que un solo estudio llegara a un acuerdo con Kentaro.
                </p>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Debido a esto, el manga ha quedado sin un anime referente (por ahora) que pueda llevarlo a las pantallas al nivel que se merece.
                </div>
