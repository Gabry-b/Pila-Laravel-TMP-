    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">¿Existe algún videojuego puramente de Berserk?.</h1></br>
                <p class="text-muted">Berserk ha influido a decenas de videojuegos a lo largo de la historia (Dark Souls, Sekiro, Nioh...) pero apenas se conocen los titulos propios de la marca.</p></br>
                <img src="noticias/berserk/n9.jpg" class="w-50" alt="">
                </br>
            </div>
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Berserk es una saga de videojuegos con títulos en la base de datos de los videogames desde 2016 y que actualmente cuenta con un juego para PS4, PSVITA, PC, PS3. 
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                <h2>BERSERK AND THE BAND OF THE HAWK</h2>
                </div>
                <img src="noticias/berserk/n9.1.jpg" class="w-25" alt="">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Berserk o Berserk Musou para PSVITA es un juego de acción de tipo "Musou", al estilo Dynasty Warriors, basado en el tebeo japonés o manga Berserk. El título sigue la historia del tebeo y lo combinará con el estilo de batallas abiertas que hemos visto en los diferentes juegos musou.
                </div>
                <img src="noticias/berserk/n9.2.jpg" class="w-50" alt="">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                ...
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Os dejamos con un video del gameplay en PS4 Pro de este maravilloso juego:
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
