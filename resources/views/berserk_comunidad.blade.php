    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">¡Únete a nuestra comunidad Berserk!</h1></br>
                <p class="text-muted">¡Guts y Casca te necesitan! Únete a nuestro canal de Discord donde podrás disfrutar de la comunidad para diversas actividades</p></br>
            ...
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Bienvenidos a la Banda del Halcón de la mano de Medieval World. Dentro de ésta podréis compartir información sobre los mangas, animes y demás del mundo de Kentaro Miura. Dentro de nuestro servidor encontrarás:
                </div>
                  <ul>
                    ...
                    <br/><br/>
                    <li><b>Chat de texto del manga:</b> Aquí podrás añadir imágenes, comentarios y opiniones acerca de cada capitulo o tomo del manga de Berserk.</li>
                    <br/>
                    <img src="noticias/berserk/c1.2.png" class="w-5">
                    <br/><br/>
                    <li><b>Chat de texto del anime:</b> Aquí podrás añadir imágenes, comentarios y opiniones acerca de cada anime de Berserk.</li>
                    <br/>
                    <img src="noticias/berserk/c.1.5.png" class="w-5">
                    <br/><br/>
                    <li><b>Sección de eventos:</b> Aquí podrás participar en sorteos periódicos que publicaremos a través de su respectivo chat, así como quedar con más usuarios del servidor y asistir juntos a eventos (quien sabe, tal vez encontréis a vuestro Guts/Casca).</li>
                    <br/>
                    <img src="noticias/berserk/c1.3.png" class="w-5">
                    <br/><br/>
                    <li><b>Club de lectura:</b> Reune a tu grupo y leed las aventuras de Miura juntos, pudiendo ir alternando al lector, quedando para llegar hasta cierto capitulo por vuestra cuenta y después comentarlo, o como más se adapte a vosotros (recordad que esta es vuestra comunidad, ¡vosotros elegís!).</li>
                    <br/>
