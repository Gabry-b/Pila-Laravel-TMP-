    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">Elden Ring: Juega como Link Oscuro, Harry Potter, Darth Vader o Darth Maul gracias a los mods</h1></br>
                <p class="text-muted">La comunidad de 'modders' de Elden Ring presenta una serie de nuevas apariencias para nuestros personajes, que incluyen la versión oscura de Link, los dos Sith y el joven aprendiz de magia.</p></br>
                <img src="noticias/elden/n7.jpg" class="w-50" alt="">
                </br>
            </div>
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Elden Ring, lo último de FromSoftware que ya ha superado los 13 millones de copias vendidas en todo el mundo, recibe una nueva variedad de mods que harán las delicias de los fans de The Legend of Zelda, Star Wars y Harry Potter.</div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  En estas últimas semanas hemos visto atuendos de lo más llamativos de parte de los usuarios más creativos: ejemplos hay varios, aunque nos quedamos sin duda con los dos jugadores que decidieron ponerse en la piel de Frodo y Sam de El Señor de los Anillos y los que decidieron vestirse como Jesucristo y Satanás para atormentar a un usuario invasor.</div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  Tal y como podemos ver en los vídeos compartidos por varios jugadores (vía DSOG), estas nuevas modificaciones nos permiten jugar como Link Oscuro de The Legend of Zelda, Darth Maul y Darth Vader de Star Wars y, además, con Harry Potter.
                </p>
        </section>
    </article>
<!--PUBLICADO POR-->
