    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">Motivo por el que la serie de El Señor de los Anillos no se parece a las películas</h1></br>
                <p class="text-muted">Todos queremos que la serie de El Señor de los Anillos sea lo más fiel posible a las historias de Tolkien, pero hay problemas legales.</p></br>
            ...
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Las trilogías de El Señor de los Anillos y de El Hobbit son películas muy exitosas que llegaron a recaudar más de 5.887 millones de dólares entre todas. Sus diseños nos llevaron directamente a la fascinante Tierra Media creada por J. R. R. Tolkien. Pero ahora, están preparando la serie que tratará sobre una época anterior, pero los lugares, ropas, armas y demás elementos no pueden parecerse a lo que vimos en el cine por problemas legales, según se pudo leer en el extenso artículo de Vanity Fair.
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Aun así, los responsables del programa tratan de sortear todos estos inconvenientes y ofrecer un espectáculo que guste a todo el mundo.

                  El gran problema es que las películas de El Señor de los Anillos tienen licencia completa, al igual que los diseños utilizados en ellas. Por eso, los personajes como Galadriel y Elrond no serán iguales que las versiones de Peter Jackson.

                </div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  Al crear la serie, el objetivo de los showrunners J.D. Payne y Patrick McKay era hacer algo diferente pero familiar. Por eso, actores como Morfydd Clark (Galadriel) y Robert Aramayo (Elrond) fueron elegidos por poder aparentar ser la versión joven de las versiones de Cate Blanchett y Hugo Weaving de las películas de Peter Jackson.
                </p>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  Incluso Benjamin Walker, quien interpreta a Gil-galad, se parece a Mark Ferguson, quien apareció como el Rey Elfo en el prólogo de la primera película de El Señor de los Anillos.
                </p>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  Sí que antes de empezar a ver la serie hay que tener dos cosas muy claras. La primera es que este no es exactamente el mundo de las películas de El Señor de los Anillos. La segunda es que se han tomado muchas licencias creativas con los escritos de Tolkien, ya que dejó poca información y han rellenado los huecos con tramas y personajes inventados. Aquí os dejamos el tráiler de la serie de El Señor de los Anillos:
                </p>
                <video class="col-12" controls>
                  <source  type="video/mp4" src="noticias/videos/El Señor de los Anillos_ Los Anillos de Poder - Teaser Trailer _ Prime Video.mp4">
                </video>
            </div>
        </section>
    </article>
