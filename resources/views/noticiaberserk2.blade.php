    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">El manga de Berserk tiene un digno final gracias a un fan</h1></br>
                <p class="text-muted">El mayor homenaje que se puede hacer a Kentaro Miura, el mangaka de Berserk</p></br>
                <img src="noticias/berserk/n2.jpg" class="w-50" alt="">
                </br>
            </div>
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Hace un año de la muerte de Kentaro Miura, el autor de uno de los mangas más influyentes en la cultura actual de la historia.

                  Muchos de los videojuegos o cómics que se hacen hoy en día beben muchísimo de la estética de Berserk, algunos ejemplos son los videojuegos de From Software como Elden Ring o los Dark Souls. 
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Como ya sabréis el manga ha quedado inconcluso, con un último capítulo publicado poco después de la muerte del autor cierra así el tomo 41, aunque todavía quedaba mucha tela que cortar.

                  El capítulo 364 fue un gran capítulo final, con una extraña sensación de paz en Guts, el protagonista, aunque con un cliffhanger importante. Por suerte un fan ha decidido continuar a su modo.
                </div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  Como podéis ver, @theophiasco está realizando una continuación espectacular del trabajo de Miura. Aunque el arte sea algo distinto el tono y la composición de sus escenas recuerda mucho al trabajo original.

                  odavía no ha terminado todo el proceso, pero está colgando todas las páginas que lleva. El final para Berserk que está imaginando, que probablemente sea el manga de su vida, seguramente no sea el mismo que el del mangaka, pero sin duda alguna es un homenaje como pocos se han podido hacer.
                </p>
            </div>
        </section>
    </article>
