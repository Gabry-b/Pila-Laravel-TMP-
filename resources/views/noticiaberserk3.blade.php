    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">Berserk pone fecha a otro capítulo de su manga para este año</h1></br>
                <p class="text-muted">Pese a su inactividad respecto a la publicación de Berserk, los lectores contarán con un nuevo episodio tan solo dos meses después</p></br>
            ...
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  A pesar de que en estos últimos años el manga de "Berserk", de la mano de Kentaro Miura, se ha visto publicado con cierta irregularidad en sus nuevos episodios, parece que los lectores se encuentran en una nueva época 'dorada'.

                  Así pues, después de que durante el pasado 24 de abril se publicara un nuevo episodio tras más de medio año de parón, conocemos ahora que el siguiente episodio en el manga de "Berserk" se hará de rogar muy poco. 
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Como podemos comprobar, el manga de "Berserk" volverá una vez más a la acción durante el 26 de junio de 2022.

                  Para aquellos que desconozcan "Berserk", un verdadero clásico del manga cuya publicación oficial dio comienzo durante 1989, destacaremos que su universo se encuentra ubicado en un contexto medieval con toques de fantasía - siempre bajo un tono 'oscuro' -.
                </div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  El protagonista de la narrativa es Guts, un mercenario que desde su nacimiento solo conoció la guerra y la muerte. Guts pasa su juventud de un lugar a otro, entre tragedias y dramas - sin una familia real -, creciendo poco a poco hasta convertirse en un temible guerrero capaz de blandir una espada de gigantescas proporciones.
                </p>
            </div>
        </section>
    </article>
