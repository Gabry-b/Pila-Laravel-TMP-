          ...
          <div class="row">
              <div class="col-sm">
                  <div class="card w-100 card-border mb-5">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Según la revista Young Animal, no habrá más Berserk de momento</h5>
                        ...
                        <a href="noticiaberserk1.blade.php" class="btn btn-primary">Leer más</a>
                      </div>
                    </div>
              </div>
              <div class="col-sm">
                  <div class="card w-100 card-border mb-5">
                      ...
                      <div class="card-body">
                        ...
                        <a href="noticiaberserk2.blade.php" class="btn btn-primary">Leer más</a>
                      </div>
                    </div>
              </div>
              <div class="col-sm">
                  <div class="card w-100 card-border mb-5">
                      ...
                      <div class="card-body">
                        <h5 class="card-title">Berserk pone fecha a otro capítulo de su manga para este año</h5>
                        <p class="card-text">Pese a su inactividad respecto a la publicación de Berserk, los lectores contarán con un nuevo episodio tan solo dos meses después</p>
                        <a href="noticiaberserk3.blade.php" class="btn btn-primary">Leer más</a>
                      </div>
                  </div>
              </div>
          </div>
            ...
            <div class="col-sm">
                <div class="card w-100 card-border mb-5">
                    ...
                    <div class="card-body">
                      ...
                      <a href="noticiaberserk4.blade.php" class="btn btn-primary">Leer más</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm">
                <div class="card w-100 card-border mb-5">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">Recientemente los chicos de Man At Arms: Reforged nos sorprendían con la forja de un nuevo arma procedente de la obra de ficción.</p>
                      <a href="noticiaberserk5.blade.php" class="btn btn-primary">Leer más</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm">
                <div class="card w-100 card-border mb-5">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">Las consecuencias psicológicas del Eclipse</h5>
                      <p class="card-text">El Eclipse fue el fatídico evento que determino la historia de Berserk. Descubre las principales consecuencias psicológicas de Guts.</p>
                      <a href="noticiaberserk6.blade.php" class="btn btn-primary">Leer más</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm">
                <div class="card w-100 card-border mb-5">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text">El grupo más misterioso de Berserk, encargado del destino de Griffith, queda expuesto en el siguiente post, no te lo pierdas</p>
                      <a href="noticiaberserk7.blade.php" class="btn btn-primary">Leer más</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm">
                <div class="card w-100 card-border mb-5">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">¿Por qué el manga Berserk no ha sido adaptado (de buena manera) al anime?</h5>
                      ...
                      <a href="noticiaberserk8.blade.php" class="btn btn-primary">Leer más</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm">
                <div class="card w-100 card-border mb-5">
                    ...
                    <div class="card-body">
                      <h5 class="card-title">¿Existe algún videojuego puramente de Berserk?.</h5>
                      ...
                      <a href="noticiaberserk9.blade.php" class="btn btn-primary">Leer más</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div>
        <div class="col-sm">
            <div class="card w-100 card-border mb-5">
                ...
                <div class="card-body">
                  <h5 class="card-title">¡Únete a nuestra comunidad Berserk!</h5>
                  <p class="card-text">¡Guts y Casca te necesitan! Únete a nuestro canal de Discord donde podrás disfrutar de la comunidad para diversas actividades</p>
                  <a href="berserk_comunidad.blade.php" class="btn btn-primary">Leer más</a>
                </div>
              </div>
        </div>
        <div class="col-sm">
          ...
          <div class="carousel-inner">
              <div class="carousel-item active">
                  ...
                  <div class="carousel-caption d-none d-md-block">
                      ...
                      <h5 class="animated fadeInLeft" style="animation-delay: 3s">Pelea épica en la loma del Monte del Demonio</h5>
                  </div>
              </div>
              ...
              <div class="carousel-item">
                  ...
                  <div class="carousel-caption d-none d-md-block">
                      <h3 class="animated zoomIn" style="animation-delay: 1s">"Perversión"</h3>
                  </div>
              </div>
              <div class="carousel-item">
