    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">Se convierten en Frodo y Sam en Elden Ring</h1></br>
                <p class="text-muted">Un vídeo de TikTok que se ha viralizado en redes sociales muestra a dos Sinluz caracterizados como Frodo y Sam recorriendo paisajes de las Tierras Intermedias.</p></br>
                <img src="noticias/elden/N2.jpg" class="w-50" alt="">
                </br>
            </div>
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Los sistemas de juego, personalización y cooperación de Elden Ring permiten a los jugadores más dedicados e imaginativos rolear de maneras inesperadas. Por ejemplo, la pareja de Jesucristo y Satanás que un Sinluz se encontró explorando las Tierras Intermedias. 

                  Hoy os traemos otro caso similar, pero todavía más trabajado si cabe. Dos jugadores han vestido a sus avatares como a Frodo y Sam de El Señor de los Anillos para explorar escenarios del RPG de FromSoftware que recuerdan a secuencias de los filmes. 
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  El usuario de TikTok p1cklel0verr ha sido quien ha subido el vídeo a la mencionada red social, desde la que se ha difundido a otras plataformas como Twitter, Instagram y Reddit donde no han tardado en viralizar.
                </div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  En el metraje se intenta recrear Lord of the Elden Rings, básicamente el viaje (muy resumido) desde Rivendell hasta Mordor de Frodo y Sam, dos avatares creados como Elijah Wood (Frodo Bolsón) y Sean Astin (Samsagaz Gamyi) y vestidos con los Ropajes de paje superior y las Perneras de reina (ambos se encuentran en la Academia de Raya Lucaria).
                </p>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  <video class="col-12" controls>
                    <source  type="video/mp4" src="noticias/videos/PS4 Pro _ Berserk and the Band of Hawk - 6 Minutes of Berserk Armor Gameplay (1080p 60fps).mp4">
                  </video>
                </p>
            </div>
        </section>
