    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                ...
                <p class="text-muted">El grupo más misterioso de Berserk queda expuesto en el siguiente post, no te lo pierdas</p></br>
            ...
            <div class="container py-2 text-center">
                ...
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  <video class="col-12" controls>
                    <source  type="video/mp4" src="noticias/videos/BERSERK 362_ LA ANTERIOR MANO DE DIOS _ ANÁLISIS Y TEORÍAS.mp4">
                  </video>
                </div>
            </div>
        </section>
