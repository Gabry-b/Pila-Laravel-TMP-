    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                ...
                <p class="text-muted">Recientemente los chicos de Man At Arms: Reforged nos sorprendían con la forja de un nuevo arma procedente de la obra de ficción.</p></br>
            ...
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  En esta ocasión, a petición de los seguidores, han decidido forjar la Dragonslayer (Matadragones) de Guts, el protagonista del popular manga Berserk.

                  El resultado, como siempre, espectacular, solo que en este caso lo es aún más dada la magnitud de la bestia de acero.
                </div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
