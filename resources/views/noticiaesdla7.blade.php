    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">House of the dragon: HBO no teme competir contra serie de Lord of the rings</h1></br>
                <p class="text-muted">El spin-off de Game of thrones se acerca, pero las comparaciones con la serie The rings of power no se hicieron esperar.</p></br>
                <img src="noticias/esdla/n7.jpeg" class="w-50" alt="">
                </br>
            </div>
