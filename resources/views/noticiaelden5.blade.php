    ...
    <article>
        <section>
            <div class="container-fluid py-2 text-center">
                <h1 class="display-4">Elden Ring recibe un nuevo parche que nerfea a Malenia, la Espada de Miquella</h1></br>
                <p class="text-muted">El título de FromSoftware se actualiza a la versión 1.04.2 para introducir algunas correcciones menores y corregir un error por el que Malenia restauraba PS sin tocar al jugador.</p></br>
                <img src="IMAGES_ELDEN/BIG_ANIMATION.gif" class="w-50" alt="">
                </br>
            </div>
            <div class="container py-2 text-center">
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  FromSoftware y Bandai Namco han lanzado un nuevo parche de actualización para la versión 1.04 de Elden Ring que, a grandes rasgos, equilibra al jefe de Malenia, la Espada de Miquella. 

                  Esto es debido a que el último gran parche para lo nuevo de Hidetaka Miyazaki introdujo algunos cambios que hicieron que vencer a Malenia, uno de los jefes opcionales más complicados del juego, fuera todavía más difícil.</div>
                <div class="text-center  col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead" id="noticias">
                  Esta no es la primera vez que el estudio lanza una corrección para nerfear a un jefe, y es que a principios de este mes se lanzó una actualización para la versión 1.03 que corrigió algunos ataques de Radahn.</div>
                <p class="col-lg-12 col-md-12 col-sm-12 p-5 display-7 lead">
                  Se ha corregido un error por el que la duración del efecto de la Lágrima oculta cerúlea fue corregido a la baja.
                  Se ha corregido un error con Malenia, la Espada de Miquella, por el que sus PS no se curaban correctamente en el entorno multijugador online.
                  Se ha corregido un error que provocaba que algunos jefes murieran en momentos no intencionados.
                  Se ha corregido un error que impedía que el jefe Bestia del Círculo funcionara correctamente en determinadas circunstancias.
